...
# ---------------- DYNAMIC SNAKE SVG ----------------
# Snake glow intensity based on commits
glow_intensity = min(5 + commits, 25)  # cap at 25 for max glow
snake_svg = f"""
...
"""
# Save SVG to a public path in your repo
snake_svg_path = "output/github-snake-dynamic.svg"
os.makedirs(os.path.dirname(snake_svg_path), exist_ok=True)
...
# Replace previous summary between markers
...
# Replace snake SVG link marker
start_snake = "<!-- SNAKE_START -->"
end_snake = "<!-- SNAKE_END -->"
snake_img_tag = f"{start_snake}\n<p align='center'>\n  <img src='{snake_svg_path}' width='700'/>\n</p>\n{end_snake}"
